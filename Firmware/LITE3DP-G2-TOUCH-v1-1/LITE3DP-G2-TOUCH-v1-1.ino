...
/*
  ...
  7) XPT2046 Touchscreen Arduino Library by PaulStoffregen
     https://github.com/PaulStoffregen/XPT2046_Touchscreen

  8) Converter tool, file to C style array converter by notisrac
...
int PrintMode; // 0:micro SD File, 1:Keychain test, 2:Touch pencil test
...
void setup(void) {
  ...
  displaymenuintro();
  tft.drawCentreString("V1.1", 240, 270, 4);
  delay(1200);
...
void loop() {
  ...
  if (ts.tirqTouched()) {
    if (ts.touched()) {
      ...
      yPixel = map(p.y, TS_MINX, TS_MAXX, 0, 320);
      xPixel = map(p.x, TS_MINY, TS_MAXY, 0, 426);
      ...
      switch (screen) {
        ...
        case 0: case 1: case 2:
          ...
          if (xPixel > 0 && xPixel < 120) {
            btnDOWNmenu();
            delay(50);
          }

          else if (xPixel > 150 && xPixel < 300) {
            btnNEXTmenu();
            delay(50);
          }

          else if (xPixel > 330 && xPixel < 426) {
            btnUPmenu();
          }
          break;

        case 11: case 14: case 141: case 142: case 143: case 144: case 145: case 146: case 147: case 21: case 2010: case 10011: case 10012: case 10013: case 10014: case 10015: case 10016: case 10017: case 10018: case 10019: case 10020: case 10021: case 10022: case 10023: case 100231: case 100232: case 100233: case 100234: case 100235: case 100236:
          ...
          else if (xPixel > 350 && xPixel < 426 && yPixel > 0 && yPixel < 100) {
            btnNEXTmenu();
            delay(50);
          }

          else if (yPixel > 120 && yPixel < 200) {
            btnNEXTmenu();
            delay(50);
          }

          else if (xPixel > 0 && xPixel < 200 && yPixel > 215 && yPixel < 320) {
            btnDOWNmenu();
            delay(50);
          }

          else if (xPixel > 250 && xPixel < 426 && yPixel > 215 && yPixel < 320) {
            btnUPmenu();
            delay(50);
          }
          break;
        ...
        case 31: case 41: case 51: case 201: case 202:
          ...
          else if (yPixel > 90 && yPixel < 165) {
            btnNEXTmenu();
            delay(50);
          }

          else if (yPixel > 190 && yPixel < 320) {
            btnDOWNmenu();
            delay(10);
            btnNEXTmenu();
            delay(50);
        ...
        case 15: case 151: case 152: case 16: case 20101: case 2020: case 22: case 1140: case 310:
        ...
        case 17:
          ...
          if (xPixel > 0 && xPixel < 426 && yPixel > 0 && yPixel < 320) {
            btnBACKmenu();
            delay(50);
          }
          break;
  ...
  switch (hLayerx1000) {
    ...
    case 25:
      ...
      for (int l = 1; l <= FirstLayers ; l++) {
        tft.fillScreen(TFT_BLACK);
        delay(RestTime);
        radius = (176 - l * 0.025) / 2.5245;
        tft.fillSmoothCircle(240, 160, radius, TFT_WHITE, TFT_BLACK);
        ledcWrite(ledChannel, PWMUV);
        delay(iexpotime * 1000);
        ledcWrite(ledChannel, 0);
        TFT_BLACKscreen();
      ...
      for (int l = 0; l <= 720; l++) {
        delay(RestTime);
        radius = sqrt(36 - 2 * l * 0.025) / 0.11475;
        tft.fillSmoothCircle(240, 160, radius, TFT_WHITE, TFT_BLACK);
        ledcWrite(ledChannel, PWMUV);
        delay(expotime * 1000);
        ledcWrite(ledChannel, 0);
    ...
    case 50:
      ...
      for (int l = 0; l <= 360; l++) {
        tft.fillScreen(TFT_BLACK);
        delay(RestTime);
        radius = sqrt(36 - 2 * l * 0.05) / 0.11475;
        tft.fillSmoothCircle(240, 160, radius, TFT_WHITE, TFT_BLACK);
        ledcWrite(ledChannel, PWMUV);
        delay(expotime * 1000);
        ledcWrite(ledChannel, 0);
    ...
    case 100:
      ...
      for (int l = 0; l <= 180; l++) {
        tft.fillScreen(TFT_BLACK);
        delay(RestTime);
        radius = sqrt(36 - 2 * l * 0.1) / 0.11475;
        tft.fillSmoothCircle(240, 160, radius, TFT_WHITE, TFT_BLACK);
        ledcWrite(ledChannel, PWMUV);
        delay(expotime * 1000);
        ledcWrite(ledChannel, 0);
